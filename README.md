...
> **Status: Gate 1 (canonical data model and tenant core).** No product feature exists yet: only the
> technical base and the multi-tenant data core on which the next gates are built.
