...
# Gate 5 and Gate 7 are read-only detectors: they add no table, so the revision chain skips
# straight from Gate 6 (0007) to Gate 8 (0008).
GATE_8_TABLES = {
    "labor_snapshots",
    "labor_entries",
...
def test_upgrade_creates_the_gate_1_to_8_schema_next_to_gate_0(
